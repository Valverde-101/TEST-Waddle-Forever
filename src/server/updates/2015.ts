    ...
    temp: {
      party: {
        ...
        fileChanges: {
          ...
          // Halloween Classic ships a matching interface/quest pair. Keep the
          // original CPArchives files intact and route runtime requests to these
          // separately hydrated canonical companions instead of mixing stacks.
