...
import { handleFairAwardTicket, handleFairDailySpin, handleFairEndGame, handleFairStartGame, handleFairUseTickets } from "./handlers/fair";
...
export const createWorldXtHandler = (): XtHandler => {
  ...
  const callbacks: IntermediateXtCallbackInfo<any>[] = [
    ...
    p.xt('s', 'nx#bimp', ['string'], handleModernBitmapInteraction),
