...
$managedToolchain = Enable-WaddleManagedNodeToolchain -AndroidBuildRoot $androidBuildRoot
...
Write-Host "WADDLE_BUILD_ENTRY=PASS managed_node=$($managedToolchain.node) managed_yarn=$($managedToolchain.yarn) host_node_isolated=true runtime_mutation_guard=cross_machine"
